...
def create_OP_CHECKSIG_signature(txin, txout_1, txout_2, txin_scriptPubKey, seckey):
...
def create_signed_transaction(txin, txout_1, txout_2, txin_scriptPubKey, txin_scriptSig):
