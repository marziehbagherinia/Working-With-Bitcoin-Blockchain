...
def Vanity_address(prefix):
    private_key = os.urandom(32)
    wif_private_key = getWif(private_key)
    base58_address = get_address(private_key)
    
    while(base58_address[1:1+len(prefix)] != prefix):
        private_key = os.urandom(32)
        
        base58_address = get_address(private_key)

    wif_private_key = getWif(private_key)
    return wif_private_key, base58_address
    

wif_private_key, base58_address = Vanity_address("mba") #MBA == Marzieh Bagherinia Amiri
